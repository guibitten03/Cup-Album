...
class TradeInterface(Frame, Interface):
    ...
    def search(self):
        ...
        # self.search_msg_error_str = Label(self.Search, text='Trade successfully modified')
        ...
        self.search_msg_name = Label(self.Search,text='Trade ID:')
    ...
    def __modify_aux__(self):
        ...
        self.modify_aux_name_trade=Entry(self.Modify_aux, width=10)
        self.modify_aux_name_trade.grid(row=0, column=1, sticky=E+W, pady=5, padx=5)
        self.modify_aux_name_trade.focus_force()

        self.confirm_modify_aux = Button(self.Modify_aux, text="Modify", fg="red")
        self.confirm_modify_aux.bind("<Button-1>", lambda event: self.__modify_event_aux__(event, self.modify_aux_name_trade))
    ...
    def __modify_event_aux__(self, event, text):
        ...
        modify_trade.set_name(text.get())
